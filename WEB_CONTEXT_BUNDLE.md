...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-705-erd-s-problem-705-cc24d780-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-705"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-705-erd-s-problem-705-cc24d780-v1",
      "problem_contract_sha256": "e499fa27d84140b00d9b8f81fc72238e015c92a5aa48813fcbdd485e68222815",
      "problem_id": "problem:um-ep-705-erd-s-problem-705-cc24d780",
      "route_id": "route:um-ep-705-erd-s-problem-705-cc24d780-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-705-erd-s-problem-705-cc24d780-source-fidelity-01",
      "graph_id": "graph:um-ep-705-erd-s-problem-705-cc24d780-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-705-erd-s-problem-705-cc24d780-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-705-erd-s-problem-705-cc24d780-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $G$ be a finite unit distance graph in $\\mathbb{R}^2$ (i.e. the vertices are a finite collection of points in $\\mathbb{R}^2$ and there is an edge between two points if and only if the distance between them is $1$). Is there some $k$ such that if $G$ has girth $\\geq k$ (i.e. $G$ contains no cycles of length $<k$) then $\\chi(G)\\leq 3$?"
          },
          "statement_sha256": "3f154faa546222a046f49823b0e1de9480ec94c61f239b141ecb35d5e70593a0"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-705-erd-s-problem-705-cc24d780-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-705-erd-s-problem-705-cc24d780-root",
      "route_id": "route:um-ep-705-erd-s-problem-705-cc24d780-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-705-b4ac09332fd2",
        "url": "https://www.unsolvedmath.com/problems/EP-705"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
